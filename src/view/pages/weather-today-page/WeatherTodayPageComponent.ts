    ...
    protected render(): void {
       ...
       `
        ...
        <div class='todays-details-item'>
            <div class='icon-container temp-item'></div>
        ...
        <div class='todays-details-item'>
            <div class='icon-container wind-item'></div>
        ...
        <div class='todays-details-item'>
            <div class='icon-container humidity-item'></div>
        ...
        <div class='todays-details-item'>
            <div class='icon-container cloud-item'></div>
        ...
        <div class='todays-details-item'>
        <div class='icon-container pressure-item'></div>
        ...
        <div class='todays-details-item'>
            <div class='icon-container visibility-item'></div>
